...
Principles and judgment framework for writing and updating documentation. Load this skill when creating or updating standalone documentation — AGENTS.md files, READMEs, design docs, technical docs.
