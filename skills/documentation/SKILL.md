---
name: documentation
description: Principles for writing and updating documentation — AGENTS.md files, READMEs, design docs, technical docs
---

# Documentation

Principles and judgment framework for writing and updating documentation. Load this skill when creating or updating standalone documentation — AGENTS.md files, READMEs, code comments, design docs, technical docs.

---

## Core Principle: Current State, Not Change History

Documentation describes **how the system works now**. Not what changed. Not why it changed. Not what it used to be. Avoid vestigial language.
...
- A bug fix that corrects an off-by-one error but doesn't change any interface or behavior? Nothing to document.
- A new API endpoint, a new service, a changed architectural pattern, a new convention? Probably warrants documentation.

Document what matters. Skip what doesn't. "No updates needed" is a valid and expected outcome.
...
This skill covers standalone documentation — AGENTS.md files, READMEs, design docs, technical docs.
